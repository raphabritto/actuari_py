...
proc sql;
	...
	and t2.COTDATA between MDY(month(t1.DtIniBenPrev), 1, year(t1.DtIniBenPrev)) and MDY(month(&DtCalAval.), 1, year(&DtCalAval.))
	and t2.MOECODIGO = 7
